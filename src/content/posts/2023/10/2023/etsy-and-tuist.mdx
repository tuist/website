...
categories: ["Etsy", "SwiftUI", "UIKit", "Modularity", "VIPER"]
type: interview
...
interviewee_name: Etsy
interviewee_url: https://www.etsy.com/
interviewee_twitter_handle: Etsy
interviewee_avatar: /integrations/etsy.png
---
...
After a basic installation, scripts automate the rest, ensuring that tools like Tuist and Ruby, specified in their [`.ruby_version`](https://en.wikipedia.org/wiki/Ruby_Version_Manager) file, are properly set up. 
