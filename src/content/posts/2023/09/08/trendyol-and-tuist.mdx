...
categories: ["Trendyol", "Apps at Scale", "VIPER", "Tuist", "Open Source", "GitLab", "Swift", "SwiftUI"]
type: interview
...
interviewee_twitter_handle: Trendyol
...
![A diagram that shows Trendyol's team structure. The platform team supports peripheral organizations such as Turkey, International, DolapLite, Grocery, and Meal, which are focused on a specific products.](/images/blog/2023/09/08/organization.png)
