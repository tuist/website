...
Further details on this topic can be found [in a presentation](https://www.droidcon.com/2022/11/15/modularization-flatten-your-graph-and-get-the-real-benefits/) given by my teammate, Josef Raska, at Droidcon.
