...
This made organizations and developer confusing about what Tuist is and what it does.
...
We will also **commoditize some pieces of technology** that we’ve noticed are common across many organizations to help elevate innovation at different layers of the stack. We believe that by doing so, we can help organizations focus on what differentiates them rather than on undifferentiated heavy lifting. Expect a handful of open-source projects from us in the coming months.
