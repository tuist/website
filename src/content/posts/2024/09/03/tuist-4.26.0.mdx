---
title: "Tuist 4.26.0: GitHub integration and new command to find implicit dependencies"
categories: ["Releases"]
...
![An screenshot that shows a GitHub comment with some links to run previews and the results from running tests](./github-app-comment.png)
